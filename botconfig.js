...
const { TOKEN, CLIENT_ID, CLIENT_SECRET, SPOTIFY_CLIENTID, SPOTIFY_SECRETID } = process.env
...
module.exports = {
  ...
  ClientSecret: process.env.Discord_ClientSecret || (CLIENT_SECRET), // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || (SPOTIFY_CLIENTID), // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || (SPOTIFY_SECRETID), // Spotify Client Secret
  },
};
